        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Send Mail To All Subscribers</li>
                </ol>
            </nav>
        </div>
    </div>
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('admin_subscribers_send_email_submit') }}"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-9 text-secondary">
                                        <textarea id="mytextarea" class="form-control" name="message">{{ old('message') }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="submit" class="btn btn-success px-4 savedata" value="Send Mail" />
                                    </div>
                                </div>
                            </form>
                        </div>
