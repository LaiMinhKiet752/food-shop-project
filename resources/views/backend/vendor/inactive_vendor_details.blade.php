...
@section('admin')
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="{{ route('inactive.vendor') }}" class="btn btn-primary"><i class="lni lni-arrow-left"> Go Back</i></a>
                </div>
            </div>
        </div>
        <!--end breadcrumb-->
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="{{ route('active.vendor.approve') }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="submit" class="btn btn-success px-4" value="ACTIVE" title="Active Vendor"/>
                                        </div>
                                    </div>
                            </div>
