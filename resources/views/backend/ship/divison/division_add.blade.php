...
@section('admin')
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="{{ route('all.division') }}" class="btn btn-primary"><i class="lni lni-arrow-left"> Go Back</i></a>
                </div>
            </div>
        </div>
        <!--end breadcrumb-->
            ...
            $('#myForm').validate({
                ...
                messages: {
                    division_name: {
                        ...
                        maxlength: 'The division name must not be greater than 255 characters.',
                    },
                },
                errorElement: 'span',
