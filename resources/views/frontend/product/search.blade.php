        ...
        <div class="col-lg-4-5">
            <div class="shop-product-fillter">
                <div class="totall-product">
                    <p>Chúng tôi tìm thấy <strong class="text-brand" style="font-weight: bold;">{{ count($products) }}</strong>
                        sản phẩm cho bạn!</p>
                </div>
                        ...
                        <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn product_search_data"
                            ...
                            <div class="product-content-wrap">
                                ...
                                <div class="product-card-bottom">
                                    ...
                                    <div class="add-cart">
                                        <input type="hidden" value="{{ $product->id }}" class="prod_search_id">
...
{{-- Start Product Search Add To Cart --}}
<script type="text/javascript">
    $(document).ready(function() {
        $('.ProductSearchAddToCart').click(function(e) {
            e.preventDefault();
            ...
            $.ajax({
                type: "POST",
                url: "/product/search/cart/store/" + id,
                data: {
                    quantity: quantity,
