        ...
        <ul class="nav flex-column" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link {{ $route == 'cancel.order.page' ? 'active' : '' }}"
                    href="{{ route('cancel.order.page') }}"><i class="fi-rs-shopping-bag mr-10"></i>Cancel Orders</a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ $route == 'return.order.page' ? 'active' : '' }}"
                    href="{{ route('return.order.page') }}"><i class="fi-rs-shopping-bag mr-10"></i>Return
                    Orders</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link {{ $route == 'user.change.password' ? 'active' : '' }}"
                    href="{{ route('user.change.password') }}"><i class="fi-rs-document mr-10"></i>Change
                    Password</a>
            </li>
            <li class="nav-item">
